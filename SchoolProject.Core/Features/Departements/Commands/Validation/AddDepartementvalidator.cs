...
{
    public class AddDepartementvalidator : AbstractValidator<AddDepartementCommand>
    {
        private readonly IStringLocalizer<SharedResources> _stringLocalizer;
        public AddDepartementvalidator(IStringLocalizer<SharedResources> stringLocalizer)
        {
